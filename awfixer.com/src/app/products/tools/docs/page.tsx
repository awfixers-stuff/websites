...
const quickStartGuides = [
  {
    ...
    description: "Install and configure AWFixer Tools in minutes.",
    href: "#getting-started",
  },
  {
    icon: Terminal,
    title: "Command Reference",
    description: "Complete reference for all built-in commands.",
    href: "#command-reference",
  },
  {
    icon: Settings,
    title: "Configuration",
    description: "Customize behavior with configuration files.",
    href: "#configuration",
  },
  {
    icon: HelpCircle,
...
const documentationSections = [
  {
    title: "Core Commands",
    description: "Essential system administration commands",
    articles: [
      "awf-disk - Disk Usage",
      "awf-proc - Process Management",
      "awf-net - Network Tools",
      "awf-log - Log Analysis",
      "awf-sys - System Information",
    ],
  },
  {
    ...
    <div>
      ...
      <div className="mb-12 text-center">
        ...
        <p className="text-muted-foreground mx-auto max-w-2xl text-lg">
          Everything you need to master AWFixer Tools. From basic commands to
