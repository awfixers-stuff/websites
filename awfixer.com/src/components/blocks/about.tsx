    ...
    <section className="container mt-10 flex max-w-5xl flex-col-reverse gap-8 md:mt-14 md:gap-14 lg:mt-20 lg:flex-row lg:items-end">
      ...
      <div className="flex flex-col gap-8 lg:gap-16 xl:gap-20">
        ...
        <TextSection
          title="The team"
          paragraphs={[
            "We started building AWFixer in 2023 and launched in 2024. Every component has been designed from the ground up — with no technical debt or legacy systems. We are purpose-built to power web development innovation for the next hundred years.",
            ...
            "If you're interested in building the future of web development, check out our open roles below.",
          ]}
          ctaButton={{
            href: "/careers",
      ...
      <div className="flex flex-col gap-8 lg:gap-16 xl:gap-20">
        <TextSection
          paragraphs={[
            ...
            "We're developer-obsessed — investing the time to understand every aspect of your workflow so that we can help you build better than ever before. We're all in this together because your success is our success. In our history as a company, we've never lost a customer, because when your applications succeed, so do we.",
          ]}
        />
        <ImageSection
          images={[
