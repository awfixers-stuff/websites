...
- Support Bonus: Additional 10% (25% total) when actively supporting users via your [Template Queue](https://awfixer.forum/my-template-queue)
...
When users have questions about your template, they'll appear in your [Template Queue](https://awfixer.forum/my-template-queue) in Central Station. You'll get an email when new questions come in, plus occasional reminders if questions are waiting. 
