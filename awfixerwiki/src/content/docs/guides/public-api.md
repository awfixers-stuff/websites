...
If you run into problems using the API or have any suggestions, feel free to join our [Discord server](https://discord.awfixer.me) where you can interact with the engineers working on the API directly.
